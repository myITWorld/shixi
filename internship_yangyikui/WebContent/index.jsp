...
*{margin:0px}
 ...
 <frameset rows="18%,*" border="0">
	<frame src="<c:url value='/jsp/article/indexHeader.jsp'/>" frameborder="0" scrolling="no"    />
   <frameset cols="19%,*">
    	<frame src="<c:url value='/jsp/article/indexLeft.jsp'/>" frameborder="0" scrolling="no"   />
      <frame name="userM" frameborder="0" scrolling="auto" src="<c:url value='/article/showArticle.ao?method=preArticleList'/>"  noresize="noresize"/>
    </frameset>
 </frameset> 
 </html>