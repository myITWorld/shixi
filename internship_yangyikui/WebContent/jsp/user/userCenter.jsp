...
<frameset rows="10%,*" border="0">
    ...
    <frameset cols="19%,*">
    	<frame src="<c:url value='/jsp/user/userleft.jsp'/>" frameborder="0" scrolling="no"   />
      <frame name="userM" frameborder="0" scrolling="auto" src="<c:url value='/jsp/user/userInfo.jsp'/>"  noresize="noresize"/>
    </frameset>
    </frameset>
</html>