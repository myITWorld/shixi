 ...
 * @xtype treegrid
 */
Ext.ux.tree.checkBoxTreeGrid = Ext.extend(Ext.tree.TreePanel, {
    rootVisible : false,
    useArrows : true,
    lines : false,
    ...
    initComponent : function() {
        ...
        if(!l){
            ...
            l.createNode = function(attr) {
                if (!attr.uiProvider) {
                    attr.uiProvider = Ext.ux.tree.checkBoxTreeGridNodeUI;
                }
                    ...
                    '<div class="x-treegrid-header-inner">',
                        '<div class="x-grid3-header-offset">',
                            ...
                            '<td class="x-grid3-hd x-grid3-cell x-treegrid-hd" style="text-align: {align};" id="', this.id, '-xlhd-{#}">',
                                '<div class="x-grid3-hd-inner x-treegrid-hd-inner" unselectable="on" id="'+this.columns[0].dataIndex+'">',
    ...
    updateColumnWidths : function() {
        ...
        for(i = 0; i<colCount; i++) {
            ...
            for(j = 0; j<groupCount; j++) {
                ...
                if(g.childNodes[i]==null||g.childNodes[i]=="undefined"){
                	return;
                }
                if(i==0){
                	g.childNodes[i].style.width=450;
                }else{
                	g.childNodes[i].style.width=300;
                }
    ...
    handleHdDown : function(e, t){
    	var divObj=document.getElementById("1001")
    	var divHTML=divObj.innerHTML;
    	var i = divHTML.toLowerCase().indexOf("checked");
		if(i==-1){
			divObj.innerHTML =divHTML;
		}else{
			var j = divHTML.indexOf("INPUT");
			divObj.innerHTML = divHTML.substring(0,j+5).concat(" checked ").concat(divHTML.substring(j+5,divHTML.length));
		}
    ...
    registerNode : function(n) {
        ...
        if(!n.uiProvider && !n.isRoot && !n.ui.ischeckBoxTreeGridNodeUI) {
            n.ui = new Ext.ux.tree.checkBoxTreeGridNodeUI(n);
        }
    }
});

Ext.reg('checkboxtreegrid', Ext.ux.tree.checkBoxTreeGrid);